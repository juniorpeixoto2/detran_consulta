...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?php echo base_url('assets/painel') ?>/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="senha" required class="form-control" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
